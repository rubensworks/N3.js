...
N3Store.prototype = {
  ...
  _invalidateEntitiesKeys: function () {
    this._cachedEntitiesKeys = null;
  },

  _getEntitiesKeys: function () {
    if (!this._cachedEntitiesKeys) {
      this._cachedEntitiesKeys = Object.keys(this._entities);
    }
    return this._cachedEntitiesKeys;
  },
  ...
  _findInIndex: function (index0, key0, key1, key2, name0, name1, name2, graph) {
    var results = [], entityKeys = this._getEntitiesKeys(), tmp, index1, index2;
