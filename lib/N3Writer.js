...
// Allowed characters in names according to the spec: http://www.w3.org/TeamSubmission/turtle/#name
var regexNameStartChar = "a-zA-Z_\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u10000-\uEFFFF",
    regexNameChar      = regexNameStartChar + "\\-0-9\u00B7\u0300-\u036F\u203F-\u2040";
...
N3Writer.prototype = {
  ...
  // ### `_writeContext` writes a context to the output stream
  _writeContext: function (context, done) {
    if (context[0] === '"')
      throw new Error('A literal as context is not allowed: ' + context);
    this._writeUriOrBlankNode(context, done);
  },
  ...
  addQuad: function (subject, predicate, object, context, done) {
    // If the triple was given as a triple object, shift parameters
    if (!object) {
      done = predicate;
      object = subject.object;
    ...
    try {
      ...
      this._write(' ', null);
      this._writeContext(context, done);
    }
    catch (error) {
      done && done(error);
    }
  ...
  addPrefixes: function (prefixes, done) {
    ...
    if (hasPrefixes) {
      ...
      this._prefixRegex = new RegExp('^(' + prefixURIs + ')([' + regexNameStartChar + '][' + regexNameChar + ']*)$');
    }
